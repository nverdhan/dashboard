                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu notification-menu right" role="menu">
                                ...
                                <li class="clearfix">
                                    <i class="st-pencil"></i> 
                                    <a href="#" class="notification-user"> StudentName </a> 
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown">
                                <img class="user-avatar" src="assets/img/avatars/male.jpg" alt="{{Session::get('studentname')}}">{{Session::get('studentname')}}</a>
                                <ul class="dropdown-menu right" role="menu">
                                    <li><a href="{{URL::to('profile')}}"><i class="st-user"></i> Profile</a>
                                    </li>
                                    <li><a href="#"><i class="st-settings"></i> Settings</a>
                                    </li>
                                    <li><a href="{{ URL::to('logout') }}"><i class="im-exit"></i> Logout</a>
                                    </li>
                                </ul>
                            </li>
